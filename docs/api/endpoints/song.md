...
| Response DTO | <code>NetworkApiAudioResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
...
| Response DTO | <code>NetworkApiAudioAccompanyMatchingResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
...
| Response DTO | <code>NetworkApiAudioKtvTotalResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
...
| Response DTO | <code>NetworkApiAudioRelatedResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
...
| Response DTO | <code>NetworkApiKmrAudioMvResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
...
| Response DTO | <code>NetworkApiKrmAudioResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
| 协议组件 | <code>ApiRequestSigner</code>, <code>ApiSession</code> |
...
| Response DTO | <code>NetworkApiPrivilegeLiteResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
| 协议组件 | <code>ApiRequestSigner</code>, <code>ApiSession</code> |
...
| Response DTO | <code>NetworkApiSongClimaxResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
| 协议组件 | <code>ApiRequestSigner</code>, <code>ApiSession</code> |
...
| Response DTO | <code>NetworkApiSongRankingResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
| 协议组件 | <code>ApiRequestSigner</code>, <code>ApiSession</code> |
...
| Response DTO | <code>NetworkApiSongRankingFilterResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
| 协议组件 | <code>ApiRequestSigner</code>, <code>ApiSession</code> |
...
| Response DTO | <code>NetworkApiSongUrlResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
| 协议组件 | <code>ApiRequestSigner</code>, <code>ApiSession</code>, <code>ApiDeviceIdentity</code> |
...
| Response DTO | <code>NetworkApiSongUrlNewResponse</code>；含 UNKNOWN 时先使用宽容中间结构 |
| 传输实现 | <code>Retrofit</code> |
