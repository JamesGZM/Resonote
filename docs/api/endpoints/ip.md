...
| Response DTO | <code>NetworkApiIpResponse</code>；含 UNKNOWN 时不得据此生成严格 DTO |
...
| Response DTO | <code>NetworkApiIpDateilResponse</code>；含 UNKNOWN 时不得据此生成严格 DTO |
...
| Response DTO | <code>NetworkApiIpPlaylistResponse</code>；含 UNKNOWN 时不得据此生成严格 DTO |
| 传输实现 | <code>Retrofit</code> |
| 协议组件 | <code>ApiRequestSigner</code>, <code>ApiSession</code> |
...
| Response DTO | <code>NetworkApiIpZoneResponse</code>；含 UNKNOWN 时不得据此生成严格 DTO |
| 传输实现 | <code>Retrofit</code> |
...
| Response DTO | <code>NetworkApiIpZoneHomeResponse</code>；含 UNKNOWN 时不得据此生成严格 DTO |
| 传输实现 | <code>Retrofit</code> |
| 协议组件 | <code>ApiRequestSigner</code>, <code>ApiSession</code> |
