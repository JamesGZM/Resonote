...
| Response DTO | <code>NetworkApiVideoDetailResponse</code>；含 UNKNOWN 时不得据此生成严格 DTO |
...
| Response DTO | <code>NetworkApiVideoPrivilegeResponse</code>；含 UNKNOWN 时不得据此生成严格 DTO |
| 传输实现 | <code>Retrofit</code> |
| 协议组件 | <code>ApiRequestSigner</code>, <code>ApiSession</code>, <code>ApiDeviceIdentity</code>, <code>ApiResponseDecoder</code> |
...
| Response DTO | <code>NetworkApiVideoUrlResponse</code>；含 UNKNOWN 时不得据此生成严格 DTO |
| 传输实现 | <code>Retrofit</code> |
