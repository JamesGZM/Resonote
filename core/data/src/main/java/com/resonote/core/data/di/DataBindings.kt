...
internal abstract class DataBindings {
    ...
    @Binds
    abstract fun bindSearchHistoryRepository(implementation: DefaultSearchHistoryRepository): SearchHistoryRepository
    ...
    @Binds
    abstract fun bindHomeRecommendationSampler(
        implementation: RandomHomeRecommendationSampler,
    ): HomeRecommendationSampler
}
