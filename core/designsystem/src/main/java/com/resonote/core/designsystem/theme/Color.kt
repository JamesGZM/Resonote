...
// Frozen Resonote brand colors; keep design/FOUNDATION.md and screenshot baselines in sync.
internal val ResonoteLightColorScheme: ColorScheme = lightColorScheme(
    ...
    secondary = Color(0xFF70585B),
    onSecondary = Color(0xFFFFFFFF),
    secondaryContainer = Color(0xFFFBDBDE),
    onSecondaryContainer = Color(0xFF281719),
    ...
    secondaryFixed = Color(0xFFFBDBDE),
    secondaryFixedDim = Color(0xFFDEBFC2),
    onSecondaryFixed = Color(0xFF281719),
    onSecondaryFixedVariant = Color(0xFF574144),
...
internal val ResonoteDarkColorScheme: ColorScheme = darkColorScheme(
    ...
    secondary = Color(0xFFDEBFC2),
    onSecondary = Color(0xFF3F2B2E),
    secondaryContainer = Color(0xFF574144),
    onSecondaryContainer = Color(0xFFFBDBDE),
