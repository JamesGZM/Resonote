...
internal interface LyricsApi {
    ...
    suspend fun searchLyric(
        @Url url: String, @Query("ver") version: Int = 1, @Query("man") man: String = "yes",
        @Query("client") client: String = "pc", @Query("hash") hash: String,
    ): JsonElement
    ...
    suspend fun downloadLyric(
        ...
        @Query("id") id: String, @Query("accesskey") accessKey: String, @Query("fmt") format: String = "krc",
